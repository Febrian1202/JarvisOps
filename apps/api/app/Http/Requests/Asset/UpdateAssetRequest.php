...
class UpdateAssetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'asset_tag' => ['required', 'string', 'max:50', Rule::unique('assets', 'asset_tag')->ignore($assetId)->whereNull('deleted_at')],
            'name' => ['required', 'string', 'max:150'],
            'category' => ['required', 'string', 'max:100'],
            'brand' => ['required', 'string', 'max:100'],
            'model' => ['required', 'string', 'max:100'],
            'serial_number' => ['required', 'string', 'max:150', Rule::unique('assets', 'serial_number')->ignore($assetId)->whereNull('deleted_at')],
